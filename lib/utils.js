...
var mergeModels = require('@tradle/merge-models')
...
var BUILTIN_MODELS = require('./base-models')
...
var utils = module.exports = {
  ...
  processModels: function (models) {
    if (!models) {
      ...
      models = mergeModels()
        .add(BUILTIN_MODELS, { validate: false })
        .add(models, { validate: false })
        .get()
    ...
    models = Object.keys(models).map(id => clone(models[id]))
